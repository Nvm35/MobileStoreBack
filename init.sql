...
-- Наушники
('Наушники Sony WH-1000XM5', 'sony-wh-1000xm5', 'Премиальные беспроводные наушники Sony с лучшим в мире шумоподавлением.', 24990.00, 'SONY-WH-1000XM5', 8, true, 'Sony', 'WH-1000XM5', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'headphones'), ARRAY['Sony', 'шумоподавление', 'премиум']),
('Наушники Sennheiser HD 660S', 'sennheiser-hd-660s', 'Студийные наушники Sennheiser HD 660S для профессионального прослушивания.', 18990.00, 'SENNHEISER-HD-660S', 5, true, 'Sennheiser', 'HD 660S', 'Металл + Кожа', (SELECT id FROM categories WHERE slug = 'headphones'), ARRAY['Sennheiser', 'студийные', 'профессиональные']),

-- Защитные стекла
('Защитное стекло ESR для iPhone 15 Pro', 'esr-screen-protector-iphone-15-pro', 'Защитное стекло ESR с технологией Easy Installation для iPhone 15 Pro.', 1290.00, 'ESR-SP-IP15P', 80, true, 'ESR', 'Easy Installation', 'Закаленное стекло', (SELECT id FROM categories WHERE slug = 'screen-protectors'), ARRAY['iPhone 15 Pro', 'легкая установка', 'защитное стекло']),
('Защитное стекло ZAGG для Samsung Galaxy S24', 'zagg-screen-protector-galaxy-s24', 'Защитное стекло ZAGG InvisibleShield для Samsung Galaxy S24.', 1990.00, 'ZAGG-SP-S24', 60, true, 'ZAGG', 'InvisibleShield', 'Закаленное стекло', (SELECT id FROM categories WHERE slug = 'screen-protectors'), ARRAY['Samsung Galaxy S24', 'InvisibleShield', 'защита']),

-- Беспроводные зарядки
('Беспроводная зарядка Samsung 15W', 'samsung-15w-wireless-charger', 'Беспроводная зарядка Samsung мощностью 15W с быстрой зарядкой.', 2990.00, 'SAMSUNG-15W-WC', 25, true, 'Samsung', '15W Wireless Charger', 'Пластик + Силикон', (SELECT id FROM categories WHERE slug = 'wireless-chargers'), ARRAY['Samsung', '15W', 'быстрая зарядка']),
('Беспроводная зарядка Belkin 10W', 'belkin-10w-wireless-charger', 'Беспроводная зарядка Belkin с поддержкой Qi стандарта.', 2490.00, 'BELKIN-10W-WC', 30, true, 'Belkin', '10W Wireless Charger', 'Пластик', (SELECT id FROM categories WHERE slug = 'wireless-chargers'), ARRAY['Belkin', '10W', 'Qi стандарт']),

-- Кабели
('Lightning кабель Apple 1м', 'apple-lightning-cable-1m', 'Официальный Lightning кабель Apple длиной 1 метр.', 1990.00, 'APPLE-LIGHTNING-1M', 100, true, 'Apple', 'Lightning Cable', 'Медь + Пластик', (SELECT id FROM categories WHERE slug = 'cables-adapters'), ARRAY['Apple', 'Lightning', 'официальный']),
('USB-C кабель Anker PowerLine III', 'anker-powerline-iii-usb-c', 'Прочный USB-C кабель Anker PowerLine III с пожизненной гарантией.', 1290.00, 'ANKER-PL3-USB-C', 75, true, 'Anker', 'PowerLine III', 'Нейлон + Металл', (SELECT id FROM categories WHERE slug = 'cables-adapters'), ARRAY['Anker', 'PowerLine III', 'прочный']),

-- Power Bank
('Портативный аккумулятор Xiaomi Power Bank 3', 'xiaomi-power-bank-3', 'Портативный аккумулятор Xiaomi Power Bank 3 емкостью 20000 мАч.', 3990.00, 'XIAOMI-PB-20000', 20, true, 'Xiaomi', 'Power Bank 3', 'Пластик', (SELECT id FROM categories WHERE slug = 'power-banks'), ARRAY['Xiaomi', '20000 мАч', 'Power Bank 3']),
('Портативный аккумулятор RAVPower 20000', 'ravpower-20000-power-bank', 'Портативный аккумулятор RAVPower емкостью 20000 мАч с быстрой зарядкой.', 3490.00, 'RAVPOWER-20000', 15, true, 'RAVPower', '20000 mAh', 'Пластик', (SELECT id FROM categories WHERE slug = 'power-banks'), ARRAY['RAVPower', '20000 мАч', 'быстрая зарядка']),

-- Подставки
('Подставка для телефона Lamicall Adjustable', 'lamicall-adjustable-stand', 'Регулируемая подставка Lamicall для телефона с углом наклона 0-180°.', 1590.00, 'LAMICALL-ADJUSTABLE', 40, true, 'Lamicall', 'Adjustable Stand', 'Алюминий', (SELECT id FROM categories WHERE slug = 'stands-holders'), ARRAY['Lamicall', 'регулируемая', '0-180°']),
('Подставка для телефона Spigen ArcStation', 'spigen-arcstation-stand', 'Компактная подставка Spigen ArcStation для телефона.', 1290.00, 'SPIGEN-ARCSTATION', 50, true, 'Spigen', 'ArcStation', 'Пластик', (SELECT id FROM categories WHERE slug = 'stands-holders'), ARRAY['Spigen', 'компактная', 'ArcStation']),

-- Стилусы
('Apple Pencil 2', 'apple-pencil-2', 'Apple Pencil 2-го поколения для iPad с магнитным креплением и беспроводной зарядкой.', 8990.00, 'APPLE-PENCIL-2', 12, true, 'Apple', 'Pencil 2', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'styluses'), ARRAY['Apple', 'iPad', 'магнитное крепление']),
('Samsung S Pen для Galaxy Tab', 'samsung-s-pen-galaxy-tab', 'Samsung S Pen для Galaxy Tab с улучшенной чувствительностью.', 2990.00, 'SAMSUNG-S-PEN', 18, true, 'Samsung', 'S Pen', 'Пластик', (SELECT id FROM categories WHERE slug = 'styluses'), ARRAY['Samsung', 'Galaxy Tab', 'чувствительность']),

-- Клавиатуры
('Клавиатура Logitech MX Keys', 'logitech-mx-keys', 'Беспроводная клавиатура Logitech MX Keys с подсветкой и мультиустройством.', 8990.00, 'LOGITECH-MX-KEYS', 10, true, 'Logitech', 'MX Keys', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'keyboards'), ARRAY['Logitech', 'беспроводная', 'подсветка']),
('Механическая клавиатура Keychron K2', 'keychron-k2-mechanical', 'Компактная механическая клавиатура Keychron K2 с переключателями Gateron.', 5990.00, 'KEYCHRON-K2', 8, true, 'Keychron', 'K2', 'Пластик + Алюминий', (SELECT id FROM categories WHERE slug = 'keyboards'), ARRAY['Keychron', 'механическая', 'Gateron']),

-- Мыши
('Мышь Logitech MX Master 3', 'logitech-mx-master-3', 'Беспроводная мышь Logitech MX Master 3 с эргономичным дизайном.', 6990.00, 'LOGITECH-MX-MASTER-3', 15, true, 'Logitech', 'MX Master 3', 'Пластик + Резина', (SELECT id FROM categories WHERE slug = 'mice'), ARRAY['Logitech', 'беспроводная', 'эргономичная']),
('Игровая мышь Razer DeathAdder V3', 'razer-deathadder-v3', 'Игровая мышь Razer DeathAdder V3 с оптическим сенсором Focus Pro 30K.', 7990.00, 'RAZER-DEATHADDER-V3', 12, true, 'Razer', 'DeathAdder V3', 'Пластик + Резина', (SELECT id FROM categories WHERE slug = 'mice'), ARRAY['Razer', 'игровая', 'Focus Pro 30K']),

-- Коврики для мыши
('Игровой коврик SteelSeries QcK', 'steelseries-qck-gaming-pad', 'Игровой коврик SteelSeries QcK с оптимальной поверхностью для игр.', 1290.00, 'STEELSERIES-QCK', 25, true, 'SteelSeries', 'QcK', 'Ткань', (SELECT id FROM categories WHERE slug = 'mouse-pads'), ARRAY['SteelSeries', 'игровой', 'QcK']),
('Коврик для мыши Corsair MM300', 'corsair-mm300-mouse-pad', 'Большой коврик для мыши Corsair MM300 с прошитыми краями.', 1590.00, 'CORSAIR-MM300', 20, true, 'Corsair', 'MM300', 'Ткань', (SELECT id FROM categories WHERE slug = 'mouse-pads'), ARRAY['Corsair', 'большой', 'прошитые края']),

-- Веб-камеры
('Веб-камера Logitech C920 HD Pro', 'logitech-c920-hd-pro', 'Веб-камера Logitech C920 HD Pro с разрешением 1080p и автофокусом.', 6990.00, 'LOGITECH-C920', 8, true, 'Logitech', 'C920 HD Pro', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'webcams'), ARRAY['Logitech', '1080p', 'автофокус']),
('Веб-камера Razer Kiyo Pro', 'razer-kiyo-pro-webcam', 'Веб-камера Razer Kiyo Pro с HDR и встроенной подсветкой.', 9990.00, 'RAZER-KIYO-PRO', 5, true, 'Razer', 'Kiyo Pro', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'webcams'), ARRAY['Razer', 'HDR', 'подсветка']),

-- Микрофоны
('Микрофон Blue Yeti USB', 'blue-yeti-usb-microphone', 'USB микрофон Blue Yeti с тремя капсулами и четырьмя режимами записи.', 8990.00, 'BLUE-YETI-USB', 6, true, 'Blue', 'Yeti USB', 'Металл + Пластик', (SELECT id FROM categories WHERE slug = 'microphones'), ARRAY['Blue', 'USB', 'три капсулы']),
('Микрофон Shure SM7B', 'shure-sm7b-microphone', 'Динамический микрофон Shure SM7B для профессиональной записи.', 24990.00, 'SHURE-SM7B', 3, true, 'Shure', 'SM7B', 'Металл', (SELECT id FROM categories WHERE slug = 'microphones'), ARRAY['Shure', 'динамический', 'профессиональный']),

-- Штативы
('Штатив Manfrotto Compact Action', 'manfrotto-compact-action-tripod', 'Компактный штатив Manfrotto Compact Action для камер и телефонов.', 2990.00, 'MANFROTTO-COMPACT', 15, true, 'Manfrotto', 'Compact Action', 'Алюминий', (SELECT id FROM categories WHERE slug = 'tripods'), ARRAY['Manfrotto', 'компактный', 'алюминий']),
('Штатив Joby GripTight PRO', 'joby-griptight-pro-tripod', 'Гибкий штатив Joby GripTight PRO для телефонов и экшн-камер.', 1990.00, 'JOBY-GRIPTIGHT-PRO', 20, true, 'Joby', 'GripTight PRO', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'tripods'), ARRAY['Joby', 'гибкий', 'GripTight']),

-- Освещение
('Кольцевая лампа Neewer 18"', 'neewer-18-inch-ring-light', 'Кольцевая лампа Neewer 18 дюймов с регулируемой яркостью и цветовой температурой.', 3990.00, 'NEEWER-18-RING', 10, true, 'Neewer', '18" Ring Light', 'Металл + Пластик', (SELECT id FROM categories WHERE slug = 'lighting'), ARRAY['Neewer', 'кольцевая лампа', '18 дюймов']),
('LED панель Godox SL-60W', 'godox-sl-60w-led-panel', 'LED панель Godox SL-60W с высокой цветопередачей для фото и видео.', 5990.00, 'GODOX-SL-60W', 8, true, 'Godox', 'SL-60W', 'Металл + Пластик', (SELECT id FROM categories WHERE slug = 'lighting'), ARRAY['Godox', 'LED панель', '60W']),

-- Карты памяти
('SD карта SanDisk Extreme Pro 128GB', 'sandisk-extreme-pro-128gb', 'SD карта SanDisk Extreme Pro 128GB с высокой скоростью записи.', 2990.00, 'SANDISK-EXTREME-128GB', 30, true, 'SanDisk', 'Extreme Pro', 'Пластик', (SELECT id FROM categories WHERE slug = 'memory-cards'), ARRAY['SanDisk', '128GB', 'высокая скорость']),
('MicroSD карта Samsung EVO Plus 256GB', 'samsung-evo-plus-256gb', 'MicroSD карта Samsung EVO Plus 256GB с адаптером.', 3990.00, 'SAMSUNG-EVO-256GB', 25, true, 'Samsung', 'EVO Plus', 'Пластик', (SELECT id FROM categories WHERE slug = 'memory-cards'), ARRAY['Samsung', '256GB', 'MicroSD']),

-- Автомобильные держатели
('Автомобильный держатель iOttie Easy One Touch', 'iottie-easy-one-touch-holder', 'Автомобильный держатель iOttie Easy One Touch с одной рукой.', 2490.00, 'IOTTIE-EASY-TOUCH', 20, true, 'iOttie', 'Easy One Touch', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'car-holders'), ARRAY['iOttie', 'автомобильный', 'одна рука']),
('Магнитный держатель Scosche MagicMount', 'scosche-magicmount-holder', 'Магнитный автомобильный держатель Scosche MagicMount.', 1990.00, 'SCOSCHE-MAGICMOUNT', 25, true, 'Scosche', 'MagicMount', 'Металл + Магнит', (SELECT id FROM categories WHERE slug = 'car-holders'), ARRAY['Scosche', 'магнитный', 'MagicMount']),

-- Автомобильные зарядки
('Автомобильная зарядка Anker PowerDrive 2', 'anker-powerdrive-2-car-charger', 'Автомобильная зарядка Anker PowerDrive 2 с двумя USB портами.', 1290.00, 'ANKER-POWERDRIVE-2', 35, true, 'Anker', 'PowerDrive 2', 'Пластик + Металл', (SELECT id FROM categories WHERE slug = 'car-chargers'), ARRAY['Anker', 'автомобильная', 'два USB']),
('Беспроводная автомобильная зарядка Belkin', 'belkin-wireless-car-charger', 'Беспроводная автомобильная зарядка Belkin с креплением на вентиляцию.', 2990.00, 'BELKIN-WIRELESS-CAR', 15, true, 'Belkin', 'Wireless Car Charger', 'Пластик + Силикон', (SELECT id FROM categories WHERE slug = 'car-chargers'), ARRAY['Belkin', 'беспроводная', 'на вентиляцию']),

-- Игровые контроллеры
('Геймпад Xbox Wireless Controller', 'xbox-wireless-controller', 'Беспроводной геймпад Xbox с улучшенной эргономикой и тактильной обратной связью.', 4990.00, 'XBOX-WIRELESS-CTRL', 12, true, 'Microsoft', 'Xbox Wireless Controller', 'Пластик + Резина', (SELECT id FROM categories WHERE slug = 'game-controllers'), ARRAY['Microsoft', 'Xbox', 'беспроводной']),
('Геймпад Sony DualSense', 'sony-dualsense-controller', 'Геймпад Sony DualSense для PlayStation 5 с адаптивными триггерами.', 5990.00, 'SONY-DUALSENSE', 10, true, 'Sony', 'DualSense', 'Пластик + Резина', (SELECT id FROM categories WHERE slug = 'game-controllers'), ARRAY['Sony', 'PlayStation 5', 'адаптивные триггеры']),

-- Игровые кресла
('Игровое кресло DXRacer Formula Series', 'dxracer-formula-gaming-chair', 'Игровое кресло DXRacer Formula Series с эргономичной поддержкой спины.', 19990.00, 'DXRACER-FORMULA', 5, true, 'DXRacer', 'Formula Series', 'Кожа + Пенополиуретан', (SELECT id FROM categories WHERE slug = 'gaming-chairs'), ARRAY['DXRacer', 'игровое кресло', 'эргономичное']),
('Игровое кресло Secretlab Titan', 'secretlab-titan-gaming-chair', 'Премиальное игровое кресло Secretlab Titan с регулируемой поясничной поддержкой.', 29990.00, 'SECRETLAB-TITAN', 3, true, 'Secretlab', 'Titan', 'Кожа + Пенополиуретан', (SELECT id FROM categories WHERE slug = 'gaming-chairs'), ARRAY['Secretlab', 'премиум', 'поясничная поддержка'])
